...
<body>
    ...
    <div class="section-user">
        <div class="container">
            <div class="row header">
                <div class="col-lg-3">
                    <img class="user-2" src="<?php echo base_url() ?>assets/images/profile_imgs/<?php echo $student_details['user_img']; ?>">
                </div>
                <div class="col-lg-6">
                    <ul class="user-list">
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card">
                        ...
                        <div class="card-body" id="corr_answer" style="display: none;">
                            <div class="alert alert-primary" role="alert">
                                <h5 class="alert-heading">Correct Answer</h5>                                
                                <hr>
                                <p class="mb-0" id="corr_getans" ></p>
                            </div>
                            <div class="alert alert-success" role="alert">
                                <h5 class="alert-heading">Explanation</h5>                                
                                <hr>
                                <p class="mb-0" id="exp_txt" ></p>
                            </div>                           
                            <div class="alert alert-warning" role="alert">
                                <h5 class="alert-heading">Reference</h5>                                
                                <hr>
                                <p class="mb-0" id="reference_link" ></p>
                            </div>                                                      
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1" style="margin-left: 25px;">
                                    <button type="button" class="btn btn-danger" data-attempt="<?php echo $GetattemptID; ?>" id="subNext" data-id='' data-type="submit">Submit</button>
                                </div>
                                <div class="col-md-1" style="margin-left: 25px;">
                                    <input type="hidden" name="questionID" id="questionID" />
                                    <button type="button" class="btn btn-secondary" id="skip" data-id="" data-type="skip">Next</button>
                                </div>
                                <!-- <div class="col-md-3">
                    ...
                    <div class="card" style="width: 401px;">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                ?>
                                    <div class="col-lg-3">
                                        <h6 class="card-title-1" id="quesVal_<?php echo $i; ?>" data-id="<?php echo $i; ?>" data-page="<?php echo $i; ?>"><?php echo $i; ?></h6>
                                ...
                                <ul style="list-style:none;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <li><button type="button" class="btn btn-primary btn-sm btn-block">Not Answered</button></li>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <li>
                                                <a class="btn btn-info btn-sm" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Final Submit</a>
                                            </li>
                                        </div>
                                    </div>
                                </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="showtestData()">
                        Sure
                    </button>
    ...
    <script type='text/javascript'>
        ...
        //     var sectionID = $(elem).attr('data-section-id');
        //     alert(sectionID);
        // }
        ...
        $(document).ready(function() {
            ...
            $('#subNext').click(function() {
                ...
                var questionID = $('#questionID').val();
                var selectedOption = $("input:radio[name=inlineRadioOptions]:checked").val();
                var attempt_id = $(this).attr('data-attempt');

                $.ajax({
                    url: '<?= base_url() ?>practice-submitAns',
                    type: 'post',
                    data: "testID=" + testID + "&CourseID=" + CourseID + "&questionID=" + questionID +
                        "&selected_answer=" + selectedOption + "&dataType=" + 'submit' + '&attempt_id=' + attempt_id,
                    dataType: 'json',
                    success: function(responseData) {
                        localStorage.setItem("lastSubmitAnswer", responseData);
                        localStorage.setItem("lastSubmitpage", page);
                        checkAnswerForbutton(page);
                        // $('#pagination').html(responseData.pagination);  
                        getAnswer_details(questionID)
                    }
                });
            })

            function getAnswer_details(questionID) {

                $.ajax({
                    url: '<?= base_url() ?>question-ref',
                    type: 'post',
                    data: "questionID=" + questionID,
                    dataType: 'json',
                    success: function(responseData) {
                        $('#corr_answer').css('display', 'block');
                        $('#corr_getans').html(responseData.correct_answer);
                        $('#exp_txt').html(responseData.correct_answer);
                        $('#reference_link').html(responseData.reference);
                    }
                });
            }
            ...
            function checkOptionValue(quesID) {
                $.ajax({
                    url: '<?= base_url() ?>Quiz/practice_CheckOptionValue',
                    type: 'post',
                    data: "QuestionID=" + quesID + '&attemptID=' + <?php echo $GetattemptID; ?>,
                    dataType: 'json',
                    success: function(responseData) {
        ...
        function checkAnswerForbutton(page) {
            ...
            let attemptID = '<?php echo $GetattemptID; ?>';
            $.ajax({
                url: '<?= base_url() ?>checkAns',
                type: 'post',
                data: "testID=" + testID + "&CourseID=" + CourseID + "&studentId=" + studentId + '&attemptID=' + attemptID,
                dataType: 'json',
                success: function(responseData) {
        ...
        function showtestData() {
            ...
            $.ajax({
                ...
                type: 'post',
                data: "testID=" + testID + '&attemptID=' + attemptID,
                dataType: 'json',
                success: function(responseData) {
    ...
    <script>
         ...
         // $testId['interval_of_break'] $testId['time_of_break']
         var IntervalOfBreak = '<?php echo $testId['interval_of_break']; ?>'; 

        var timeOfBreak = '<?php echo $testId['time_of_break']; ?>';
        ...
        var interval = setInterval(function() {
                    if(localStorage.getItem("counter") == IntervalOfBreak){                     
                        console.log('Hi Lunch Time start now');
                        $('#preview').prop('disabled', true);
                        $('#subNext').prop('disabled', true);
                        $('#skip').prop('disabled', true);                     
                       counter();
                    }else{
                        console.log('start time now');
                        $('#preview').prop('disabled', false);
                        $('#subNext').prop('disabled', false);
