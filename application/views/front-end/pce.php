 ...
 <section class="inner-header divider layer-overlay overlay-theme-colored-7 pt-100" data-bg-img="<?php echo base_url(); ?>assets/images/course-single-bg.jpg">
    <div class="container pt-200 pb-70">
      ...
      <div class="section-content">
        <div class="row"> 
          <div class="col-md-6">
            <h2 class="text-white font-36">PCE (Physiotherapy Competency Exam)</h2>
      ...
      <div class="row">
        <div class="col-md-8 blog-pull-right">
          <div class="single-service">
            <img src="<?php echo base_url(); ?>assets/images/course2.jpg" alt="">
            <h3 class="text-theme-colored line-bottom text-theme-colored">PCE (Physiotherapy Competency Exam)</h3>
            ...
            <p>The PCE (Physiotherapy Competency Examination) is a two part nationwide Canadian exam designed to test a candidate’s competency and safety to work as a licensed physical therapist. The test consists of written component and clinical component. One requires a lot of dedication, hard work and sincerity to crack this test. Our goal is to help the students understand the crux of the topics and solve simulated cases. We strategically chalk out a plan to help the students excel in their knowledge and skills by
motivating and proving their self-confidence. Our Study buddy team gives personal attention in doubt solving and helps the students in achieving their goal of clearing the test with flying colors and accomplish their dreams of working as triumphant and competent physical therapists.</p>
            <p>PCE exam has 2 components: written and clinical which is designed to test a candidate’s competency to work as a licensed physical therapist.</p>
            <p>We prepare students for the first step towards success- the written component; by improving their foundation knowledge, critical thinking, analyzing and reasoning skills.</p>
            <p>Elements include assessment and evaluation, interpretation and intervention, reassessment and professional responsibilities which cover major structures of the exam: Neuromusculoskeletal, Neurological, Cardiopulmonary-vascular and Multi-system.</p>
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="row">
                    <div class="row mtli-row-clearfix">
                        <div class="owl-carousel-1col" autoplay="false" data-dots="true">
                            <div class="item">
                                  <div class="col-md-3">
                                      <img src="<?php echo base_url(); ?>assets/images/team/pce-teacher/ankit-shahi.jpg" alt="" class="img-fullwidth">
                                  </div>
                                  <div class="col-md-9">
                                      <h2 class="mb-0">Ankit Shahi</h2>
                                      <h5>BPT, MS in Kinesiology, DPT</h5> 
                                      <li>Founder and lead instructor of Study Buddy.</li>
                                      <li>Educator specialist in Christina Hospital, DE.</li>
                                      <li>He has a doctorate in Physical Therapy (USA) and MS in Exercise Science (USA) with 7 years of teaching, research and clinical experience.</li>
                                      <li>During his 8 years of career he was nurtured by experienced and renowned professors and sports scientists.</li>
                                  </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/team/Purvi-Shahi.jpg" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Purvi Shahi</h2>
                                  <p>+1 940 999 4859</p>
                                  <h5>Licensed PT in Delaware, NY, and Pennsylvania.</h5> 
                                  <li>Doctor of Physical Therapy of clinical experience and 2 years of research in sports pedagogy.</li>
                              </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/team/Mansi-Khambati.jpg" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Mansi Khambati</h2>
                                  <h5>Bachelor of Physiotherapy. Doctorate of Physical Therapy.</h5> 
                                  <li>5 years of clinical experience in USA</li>
                              </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/team/Kiran-Naz.jpg" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Kiran Naz</h2>
                                  <p>+1 (647) 907-6014</p>
                                  <h5>BsPT, Licensed and registered therapist of NY.</h5> 
                                  <li>Student co-ordinator and manager. Instructors of PCE written component for the past 5 years.</li>
                                  <h6>Achievements</h6>
                                  <li>Mentoring PCE studybuddy students from last 4 years.<li>
                                  <li>Students Co ordintor and Manager of PCE STUDYBUDDY</li>
                                  <li>Worked as Resident physiotherapist in Bristol rehab.</li>
                                  <li>Worked as Physiotherapist in Agha Khan University Hospital.</li>
                                 
                              </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/team/Mayank-Jain.jpg" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Mayank Jain</h2>
                                  <h5>MS in Exercise therapy (USA), Certified</h5> 
                                  <li>Orthopedic manual therapist, DN practitioner, Kinesio taping practitioner with 13 years of teaching experience along with research and clinical experience</li>
                              </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/Ritika-Mentor.jpg" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Ritika Saxena</h2>
                                  <p>+91 97695 19385</p>
                                  <h5>Masters of Science (Neurorehabilitation), USA.</h5> 
                                  <li>Worked in Lilavati Hospital & Nanavati Hospital in Mumbai,India.</li>
                              </div>
                            </div>
                            <div class="item">
                              <div class="col-md-3">
                                  <img src="<?php echo base_url(); ?>assets/images/" alt="" class="img-fullwidth">
                              </div>
                              <div class="col-md-9">
                                  <h2 class="mb-0">Hitesh Sharma</h2>
                                  <p>+1 647 641 0501</p>
                                  <li>Postgraduate from India. Completed his BPTh from Pune and MPTh from Dehradun and is now working as Resident Physiotherapist in Ontario.</li>
                                  <li>Has been in teaching since 2004. Started with teaching Biology for 12 class students, during his graduation and he was taught Anatomy to MBBS students under Kazi medical classes, now he is continues his teaching passion via mentoring students preparing for PCE written component.</li>
                              </div>
                            </div>
                        </div>
                    </div>
             ...
             <div class="tab-pane fade" id="tab5">
                ...
                <ul class="list theme-colored2 paper">
                    <p>The Mentorship program is a personalized program, where the instructor attends the student on an individual basis. It is one on one training for the students who find it difficult to cope up with the general batch. We have 4-5 mentors in our team, who work on one on one basis with each student.</p>
                ...
                <ul class="list theme-colored2 paper">
                    ...
                    <div class="mentor-des">
                      <h6>Kiran Naz</h6>
                      <p>+1 (647) 907-6014</p>
                      <li>BsPT. Licensed and registered therapist of Newyork.</li>
                      <li>Student Co- ordintor and Manager.</li>
                      <li>Mentor of PCE written component for the past 5 years.</li>
                    ...
                    <div class="mentor-des">
                        <h6>Ritika Saxena</h6>
                        <p>+91 97695 19385</p>
                        <li>Masters of Science (Neurorehabilitation), USA.</li>
                        <li>Worked in Lilavati Hospital & Nanavati Hospital in Mumbai,India.</li>
                        <li>11 years of clinical practice & decision making.</li>
                        <li>Certified McKenzie Therapist.(MDT). Trained Childbirth educator.(Lamaze)</li>
