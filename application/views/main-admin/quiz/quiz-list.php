                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row">
                                                <a href="instructor-course-edit.html" class="avatar avatar-lg avatar-4by3 mb-3 w-xs-plus-down-100 mr-sm-3">
                                                    <img src="<?php echo base_url(). '/assets/images/quiz_imgs/'. $print->quiz_img; ?>" alt="Card image cap" class="avatar-img rounded">
                                                </a>
                                                <div class="flex" style="min-width: 200px;">
                                                    <!-- <h5 class="card-title text-base m-0"><a href="instructor-course-edit.html"><strong>Learn Vue.js</strong></a></h5> -->
                                                    <h4 class="card-title mb-1"><a href="<?php echo base_url().'/quiz/edit/'.$print->ID; ?>"><?php echo $print->quiz_title; ?></a></h4>
                                                  <!---  <p class="text-black-70">Let’s start with a quick tour of Vue’s data binding features.</p>--->
													...
													<!---
                                                        ...
                                                        <div class="text-center">
                                                            <a href="<?php echo base_url().'/quiz/edit/'.$print->ID; ?>" class="btn btn-sm btn-white">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card__options dropdown right-0 pr-2">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="<?php echo base_url().'/quiz/edit/'.$print->ID; ?>">Edit course</a>
                                                <div class="dropdown-divider"></div>
                                                <a href="<?php echo base_url().'quiz/delete/'.$print->ID; ?>" class="dropdown-item text-danger" href="#">Delete course</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
