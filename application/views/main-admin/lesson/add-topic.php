									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
											...
											<option>Choose Category</option>
												<option value="you_tube_link_bx" >You Tube</option>
												<option value="upload_video_bx" >Upload Video</option>
												<option value="upload_document_bx" >Upload Document</option>
												<option value="choose_quiz_bx" >Quiz</option>
											</select>
											...
											<div class="col-md-12">
												<select class="form-control" id="quiz_id" name="quiz_id">
													...
													if(!empty($quiz_list)){
														...
														?>
														<option value="<?php echo $print->ID; ?>" ><?php echo $print->quiz_title; ?></option>
														<?php
													}
													}
													?>
